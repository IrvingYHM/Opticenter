...
const App = () => {
    return (
        ...
        <h2 className="text-center text-black font-bold text-xl">Política de Cookies</h2>
        <br />  
        ...
        <p>La entidad responsable de la recogida, procesamiento y utilización de tus datos personales, en el sentido establecido por la Ley de Protección de Datos Personales es la página OptiCenter Huejutla, propiedad de Said Valdivia Hernandez – Calle Velázquez Ibarra 51, Colonia Centro, Ciudad Huejutla de Reyes, Hidalgo, c.p. 43000.</p>
        <br />
        ...
        <h2>
          <strong>¿Qué tipos de cookies existen?</strong>  
        </h2>
    ...
    <table className="w-full overflow-x-auto md:overflow-hidden bg-white shadow-md rounded-md">
      <thead className="bg-gray-200">
        <tr>
          ...
          <th className="py-2 px-4 border-b">Clase</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td className="py-2 px-4 border-b">__utma</td>
          <td className="py-2 px-4 border-b">De Terceros (Google Analytics)</td>
          <td className="py-2 px-4 border-b">2 años</td>
          <td className="py-2 px-4 border-b">Se usa para distinguir usuarios y sesiones.</td>
          <td className="py-2 px-4 border-b">No Exenta</td>
        </tr>
        <tr>
          <td className="py-2 px-4 border-b">__utmb</td>
          <td className="py-2 px-4 border-b">De Terceros (Google Analytics)</td>
          <td className="py-2 px-4 border-b">30 minutos</td>
          <td className="py-2 px-4 border-b">Se usa para determinar nuevas sesiones o visitas.</td>
          <td className="py-2 px-4 border-b">No Exenta</td>
        </tr>
        <tr>
          <td className="py-2 px-4 border-b">__utmc</td>
          <td className="py-2 px-4 border-b">De Terceros (Google Analytics)</td>
          <td className="py-2 px-4 border-b">Al finalizar la sesión</td>
          <td className="py-2 px-4 border-b">Se configura para su uso con Urchin.</td>
          <td className="py-2 px-4 border-b">No Exenta</td>
        </tr>
        <tr>
          <td className="py-2 px-4 border-b">__utmz</td>
          <td className="py-2 px-4 border-b">De Terceros (Google Analytics)</td>
          <td className="py-2 px-4 border-b">6 meses</td>
          <td className="py-2 px-4 border-b">Almacena el origen o la campaña que explica cómo el usuario ha llegado hasta la página web.</td>
          <td className="py-2 px-4 border-b">No Exenta</td>
        </tr>
      </tbody>
    </table>
    ...
    <br />
    <h2>
        <strong>Cookies de geo-localización</strong>
    </h2>
    ...
    <h2>
    <strong>Cookies de registro</strong>    
    </h2>
    ...
    <p>Las cookies de registro se generan una vez que el usuario se ha registrado o posteriormente ha abierto su sesión, y se utilizan para identificarle en los servicios con los siguientes objetivos:
        ...
        <h2>
            <strong>Cookies de analíticas</strong>
        </h2>
        <br />

        <p>
        Cada vez que un usuario visita un servicio, una herramienta de un proveedor externo genera una cookie analítica en el ordenador del usuario. Esta cookie que sólo se genera en la visita, servirá en próximas visitas a los servicios de Said Valdivia Hernandez para identificar de forma anónima al visitante. Los objetivos principales que se persiguen son:
        ...
        <br />
        <p>Este tipo de cookies permiten ampliar la información de los anuncios mostrados a cada usuario anónimo en los servicios de Said Valdivia Hernandez. Entre otros, se almacena la duración o frecuencia de visualización de posiciones publicitarias, la interacción con las mismas, o los patrones de navegación y/o comportamientos del usuario ya que ayudan a conformar un perfil de interés publicitario. De este modo, permiten ofrecer publicidad afín a los intereses del usuario.</p>

        <br />
        <h2>
            <strong>Cookies publicitarias de terceros</strong>
        </h2>
        <br />

        <p>Además de la publicidad gestionada por las webs de Said Valdivia Hernandez en sus servicios, las webs de Said Valdivia Hernandez ofrecen a sus anunciantes la opción de servir anuncios a través de terceros (“Ad-Servers”). De este modo, estos terceros pueden almacenar cookies enviadas desde los servicios de Said Valdivia Hernandez procedentes de los navegadores de los usuarios, así como acceder a los datos que en ellas se guardan.</p>
        <p>Las empresas que generan estas cookies tienen sus propias políticas de privacidad. En la actualidad, las webs de Said Valdivia Hernandez utilizan la plataforma Doubleclick (Google) para gestionar estos servicios. Para más información, acuda a
        <a href="http://www.google.es/policies/privacy/ads/#toc-doubleclick" target="_blank" rel="noreferrer">http://www.google.es/policies/privacy/ads/#toc-doubleclick</a>
        y a 
        <a href="http://www.google.es/policies/privacy/ads/" target="_blank" rel="noreferrer">http://www.google.es/policies/privacy/ads/</a>.
      </p>

      <br />

      <h2>
        <strong>¿Cómo puedo deshabilitar las cookies en mi navegador?</strong>
      </h2>
      <br />

    <p>Se pueden configurar los diferentes navegadores para avisar al usuario de la recepción de cookies y, si se desea, impedir su instalación en el equipo. Asimismo, el usuario puede revisar en su navegador qué cookies tiene instaladas y cuál es el plazo de caducidad de las mismas, pudiendo eliminarlas.
    ...
    <br />
    <h2>
        <strong>Para saber más sobre las cookies</strong>
    </h2>
    <br />
    <p>Puede obtener más información sobre la publicidad online basada en el comportamiento y la privacidad online en el siguiente <a href="http://www.youronlinechoices.com/es/">http://www.youronlinechoices.com/es/</a>
    </p>
    <br />
    ...
    <br />
    <p>
        Las webs de Said Valdivia Hernandez pueden modificar esta Política de Cookies en función de exigencias legislativas, reglamentarias, o con la finalidad de adaptar dicha política a las instrucciones dictadas por la Agencia Española de Protección de Datos, por ello se aconseja a los usuarios que la visiten periódicamente.
    </p>
    <br />
    <p>
