      ...
      try {
        const response = await fetch(
          "http://localhost:3000/clientes/enviar_codigo",
          {
            ...
            body: JSON.stringify({ vchCorreo: correoElectronico }), // Enviar el correo electrónico almacenado
          }
        );
            ...
            <div>
              ...
              {recoveryMethod === "code" && !mostrarFormularioCambio && (
                <form onSubmit={handleSubmit}>
                  ...
                  <button className="bg-blue-700 border-2 border-black hover:bg-blue-600 text-white rounded-md font-bold flex px-4 py-2 justify-center mx-auto items-center mt-4">
                    Enviar
                  </button>
                  <br />
                  <button
