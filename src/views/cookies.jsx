        ...
        <div className="bg-white shadow-md rounded-lg p-8 max-w-4xl w-full">
          <div className="text-black text-base md:text-xl e pb-6">
            ...
            <p>
              ...
              Protección de Datos Personales es la página OptiCenter Huejutla,
              propiedad de Said Valdivia Hernandez – Calle Velázquez Ibarra 51,
              Colonia Centro, Ciudad Huejutla de Reyes, Hidalgo, c.p. 43000.
            </p>
            <br />
            ...
            <p>
              ...
              usuario se mantenga identificado en los servicios de Said Valdivia
              Hernandez) o bien cuando se borran manualmente.
            </p>
            ...
            <p>
              ...
              tendrá que iniciar sesión para estar identificado. Comprobar si el
              usuario está autorizado para acceder a ciertos servicios, por
              ejemplo, para participar en un concurso. Adicionalmente, algunos
              servicios pueden utilizar conectores con redes sociales tales como
              Facebook o Twitter. Cuando el usuario se registra en un servicio
              con credenciales de una red social, autoriza a la red social a
              guardar una Cookie persistente que recuerda su identidad y le
              garantiza acceso a los servicios hasta que expira. El usuario
              puede borrar esta Cookie y revocar el acceso a los servicios
              mediante redes sociales actualizando sus preferencias en la red
              social que específica.
            </p>
            <br />
            ...
            <p>
              ...
              próximas visitas a los servicios de Said Valdivia Hernandez para
              identificar de forma anónima al visitante. Los objetivos
              principales que se persiguen son: Permitir la identificación
              anónima de los usuarios navegantes a través de la cookie
              (identifica navegadores y dispositivos, no personas) y por lo
              tanto la contabilización aproximada del número de visitantes y su
              tendencia en el tiempo. Identificar de forma anónima los
              contenidos más visitados y por lo tanto más atractivos para los
              usuarios Saber si el usuario que está accediendo es nuevo o repite
              visita. Importante: Salvo que el usuario decida registrarse en un
              servicio de Said Valdivia Hernandez, la cookie nunca irá asociada
              a ningún dato de carácter personal que pueda identificarle. Dichas
            ...
            <p>
              ...
              anuncios mostrados a cada usuario anónimo en los servicios de Said
              Valdivia Hernandez. Entre otros, se almacena la duración o
              frecuencia de visualización de posiciones publicitarias, la
              interacción con las mismas, o los patrones de navegación y/o
              comportamientos del usuario ya que ayudan a conformar un perfil de
              interés publicitario. De este modo, permiten ofrecer publicidad
            ...
            <p>
              Además de la publicidad gestionada por las webs de Said Valdivia
              Hernandez en sus servicios, las webs de Said Valdivia Hernandez
              ofrecen a sus anunciantes la opción de servir anuncios a través de
              terceros (“Ad-Servers”). De este modo, estos terceros pueden
              almacenar cookies enviadas desde los servicios de Said Valdivia
              Hernandez procedentes de los navegadores de los usuarios, así como
              acceder a los datos que en ellas se guardan.
            </p>
            <p>
              Las empresas que generan estas cookies tienen sus propias
              políticas de privacidad. En la actualidad, las webs de Said
              Valdivia Hernandez utilizan la plataforma Doubleclick (Google)
            ...
            <p>
              ...
              el comportamiento y la privacidad online en el siguiente{" "}
            ...
            <br />
            <p>
              Las webs de Said Valdivia Hernandez pueden modificar esta Política
              de Cookies en función de exigencias legislativas, reglamentarias,
              o con la finalidad de adaptar dicha política a las instrucciones
              dictadas por la Agencia Española de Protección de Datos, por ello
