...
const DetalleProducto = () => {
  ...
  const carritoApiBaseUrl = "https://edbb-201-97-61-85.ngrok-free.app/Carrito/";
  const detallesCarritoApiBaseUrl = "https://edbb-201-97-61-85.ngrok-free.app/DetalleCarrito/";

  useEffect(() => {
    const fetchProducto = async () => {
      try {
        const response = await fetch(
          "https://edbb-201-97-61-85.ngrok-free.app/productos/productosId",
          {
            method: "POST",
            headers: {
  ...
  useEffect(() => {
    const fetchGraduaciones = async () => {
      try {
        const response = await fetch("https://edbb-201-97-61-85.ngrok-free.app/graduaciones");
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchTratamientos = async () => {
      try {
        const response = await fetch("https://edbb-201-97-61-85.ngrok-free.app/Tratamiento");
        const data = await response.json();
