...
/* 
  const agregarAlCarrito = (producto) => {
    addToCart(producto);
    setProductoAgregado(producto); // Actualiza el estado para mostrar el mensaje
  }; */
  ...
  const { addToCart, removeFromCart, cart} = useCart(CartContext)
  ...
  return (
    <div className="flex-center">
      ...
      <div className="my-32">
        ...
        <p className="text-green-500">Producto agregado al carrito: {productoAgregado.vchNombreProducto}</p>
        )}
            </div>
          ...
          return (
            ...
            >
              ...
              <div className="p-2 flex flex-col items-center">
                ...
                className="py-2 px-4 bg-black text-white rounded active:bg-slate-800 disabled:opacity-50 mt-4 w-full flex items-center justify-center">
                  Agregar al carrito
...
{/*                   <svg
      ...
      {/* Footer */}
      <Fot />
{/*       <Carrito productoAgregado={productoAgregado} /> */}
    </div>
  );
};
