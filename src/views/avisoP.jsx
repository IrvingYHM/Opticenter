  ...
  return (
    ...
    <div className="bg-gray-200 min-h-screen flex justify-center items-center">
      <div className="bg-white shadow-md rounded-lg p-8 max-w-4xl w-full">
        ...
        <h2 className="text-center text-black font-bold text-xl">Aviso de privacidad</h2>
        <p>
          <strong>¿Quiénes somos?</strong>
          <br />
          OptiCenter Huejutla, mejor conocido como Said Valdivia Hernandez, con domicilio en calle Velázquez Ibarra 51, colonia Centro, ciudad Huejutla de Reyes, municipio o delegación Huejutla de Reyes, c.p. 43000, en la entidad de Hidalgo, país México, es el responsable del uso y protección de sus datos personales, y al respecto le informamos lo siguiente:
        </p>
        <p>
      ...
      <p>
            ...
            <ul>
            b) Domicilio: calle Velázquez Ibarra 51, colonia Centro, ciudad Huejutla de Reyes, municipio o delegación Huejutla de Reyes, c.p. 43000, en la entidad de Hidalgo, país México
            </ul>
            <ul>
            ...
            <ul>Para verificar y confirmar su identidad, para administrar y operar los servicios </ul>
            <p>Los datos personales que obtenemos de estas tecnologías de rastreo son los siguientes:</p>
            <ul>Identificadores, nombre de usuario y contraseñas de una sesión Idioma preferido por el usuario
            </ul>
