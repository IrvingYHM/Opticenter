      ...
      <div className="bg-gray-200 min-h-screen flex justify-center pt-24 pb-10 items-center">
        <div className="bg-white shadow-md rounded-lg p-8 max-w-4xl w-full">
          <div className="text-black text-base md:text-xl pb-6">
            ...
            <div>
              <ul>
                a) Nombre de la persona o departamento de datos personales: Said
                Valdivia Hernandez
              </ul>
              <ul>
                b) Domicilio: calle Velázquez Ibarra 51, colonia Centro, ciudad
                Huejutla de Reyes, municipio o delegación Huejutla de Reyes,
                c.p. 43000, en la entidad de Hidalgo, país México
              </ul>
            ...
            <p>
              ...
              <p>
                ...
                del consentimiento, ponemos a su disposición el siguiente medio:
              </p>
              <ul>
                Llamando al número telefónico +52 7711231054 o a través del
                sitio web oficial: www.OptiCenter.com
            ...
            <p>
              ...
              <ul>
                Asimismo, usted se podrá inscribir a los siguientes registros,
            ...
            <p>
              ...
              <ul>
                Para verificar y confirmar su identidad, para administrar y
